<?php /* Template_ 2.2.8 2016/02/19 08:44:37 D:\phpdev\workspace\media\public\_template\layouts\head.html 000005246 */ ?>
<meta charset="utf-8">
<meta name="viewport"
	content="width=device-width, initial-scale=1.0, maximum-scale=1, user-scalable=0, minimal-ui">
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="backend-base-path" content="/october//backend">
<meta name="csrf-token"
	content="Nibm3rLxyI9d5btuw5SaekuTOVWQnKKx9wL2lwdW">
<link href="<?php echo $TPL_VAR["baseUrl"]?>_template/assets/ui/storm.css?v313"
	rel="stylesheet">
<link href="<?php echo $TPL_VAR["baseUrl"]?>_template/assets/css/october.css?v313"
	rel="stylesheet">
<script src="<?php echo $TPL_VAR["baseUrl"]?>_template/assets/js/jquery-1.12.0.min.js?v313"></script>
<script src="<?php echo $TPL_VAR["baseUrl"]?>_template/assets/js/framework.js?v313"></script>
<script src="<?php echo $TPL_VAR["baseUrl"]?>_template/assets/ui/storm-min.js?v313"></script>
<script src="<?php echo $TPL_VAR["baseUrl"]?>_template/assets/js/october/october-min.js?v313"></script>
<script
	src="<?php echo $TPL_VAR["baseUrl"]?>_template/assets/js/media/mediamanager-global-min.js"></script>
<script src="<?php echo $TPL_VAR["baseUrl"]?>_template/assets/js/lang/lang.ko.js?v313"></script>
<script src="<?php echo $TPL_VAR["baseUrl"]?>_template/assets/js/october/october.flyout.js"></script>
<script
	src="<?php echo $TPL_VAR["baseUrl"]?>_template/assets/js/october/october.tabformexpandcontrols.js"></script>
<link rel="stylesheet"
	href="<?php echo $TPL_VAR["baseUrl"]?>_template/assets/css/mediamanager.css?v313">
<?php if(false){?>
<script src="<?php echo $TPL_VAR["baseUrl"]?>_template/assets/js/media/mediamanager.js"></script>
<?php }else{?>
<script src="<?php echo $TPL_VAR["baseUrl"]?>_template/assets/js/mediamanager.js"></script>
<?php }?>
<style>
body.outer {
	background: #2b3e50
...
.fancy-layout .control-tabs.secondary-tabs.content-tabs.primary-collapsed>div>ul.nav-tabs,
	.fancy-layout.control-tabs.secondary-tabs.content-tabs.primary-collapsed>div>ul.nav-tabs
	{
	background: #e67e22
}
...
.fancy-layout .form-tabless-fields, .fancy-layout .form-tabless-fields .loading-indicator-container .loading-indicator
	{
	background: #e67e22
}
